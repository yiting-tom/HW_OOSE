...
- [OOPSE Homework 6](#oopse-homework-6)
  - [Project Structure](#project-structure)
  - [Sequence diagram](#sequence-diagram)
  - [Illustrations](#illustrations)
    - [the course is full](#the-course-is-full)
    - [student has passed the course](#student-has-passed-the-course)
    - [student has taken the course](#student-has-taken-the-course)
    - [student doesn't meet the pre-requests, and without permission](#student-doesnt-meet-the-pre-requests-and-without-permission)
    - [student doesn't meet the pre-requests, but with permission](#student-doesnt-meet-the-pre-requests-but-with-permission)
    - [normally successfully register](#normally-successfully-register)
  - [client package](#client-package)
    - [client.Client class](#clientclient-class)
  - [server package](#server-package)
    - [server.Server class](#serverserver-class)
    - [server.ClientHandler class](#serverclienthandler-class)
  - [data package](#data-package)
    - [data.MockDB class](#datamockdb-class)
  - [models package](#models-package)
    - [models.course package](#modelscourse-package)
      - [models.course.Course class](#modelscoursecourse-class)
    - [models.exceptions package](#modelsexceptions-package)
      - [models.exceptions.CourseException class](#modelsexceptionscourseexception-class)
      - [models.exceptions.AlreadyTakenException class](#modelsexceptionsalreadytakenexception-class)
      - [models.exceptions.IsFullException class](#modelsexceptionsisfullexception-class)
      - [models.exceptions.NotPassedException class](#modelsexceptionsnotpassedexception-class)
    - [models.roles package](#modelsroles-package)
      - [models.roles.RoleBase abstract interface](#modelsrolesrolebase-abstract-interface)
      - [models.roles.AdminRole interface](#modelsrolesadminrole-interface)
      - [models.roles.StudentRole interface](#modelsrolesstudentrole-interface)
    - [models.users package](#modelsusers-package)
      - [models.users.User abstract class](#modelsusersuser-abstract-class)
      - [models.users.Admin class](#modelsusersadmin-class)
      - [models.users.Student class](#modelsusersstudent-class)
  - [services package](#services-package)
    - [services.AdminService class](#servicesadminservice-class)
    - [services.StudentService class](#servicesstudentservice-class)
  - [utils package](#utils-package)
    - [Hash class](#hash-class)
    - [CLIParse class](#cliparse-class)
    - [LogFormatter class](#logformatter-class)
