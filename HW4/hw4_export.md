...
- [OOPSE-Homework-4](#oopse-homework-4)
  - [Concept](#concept)
    - [models module](#models-module)
    - [services module](#services-module)
    - [UML](#uml)
    - [Demo](#demo)
    - [Details of models module](#details-of-models-module)
      - [Person Model](#person-model)
      - [BoardMember Model](#boardmember-model)
      - [Employee Model](#employee-model)
      - [Manager Model](#manager-model)
      - [Assistant Model](#assistant-model)
      - [AdministrativeAssistant Model](#administrativeassistant-model)
      - [Company Model](#company-model)
      - [Office Model](#office-model)
      - [BoardOfDirectors Model](#boardofdirectors-model)
    - [Details of services module](#details-of-services-module)
      - [CompanyService Service](#companyservice-service)
      - [WorkService Service](#workservice-service)
